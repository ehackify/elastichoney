...
cd /opt
git clone https://github.com/prasanthc41m/honeymap.git
...
stdout_logfile=/var/log/hnp/honeymap.log
stderr_logfile=/var/log/hnp/honeymap.err
autostart=true
autorestart=true
startsecs=10
EOF
...
stdout_logfile=/var/log/hnp/geoloc.log
stderr_logfile=/var/log/hnp/geoloc.err
autostart=true
autorestart=true
startsecs=10
EOF
