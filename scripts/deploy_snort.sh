...
ln -s /opt/hnp/rules/hnp.rules /opt/snort/rules/local.rules
...
wget $server_url/static/hnp.rules -O /opt/hnp/rules/hnp.rules.tmp && \
	mv /opt/hnp/rules/hnp.rules.tmp /opt/hnp/rules/hnp.rules && \
